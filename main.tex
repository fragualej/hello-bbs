...
HttpNode.observeField("response", "onHttpNodeResponse")
...
while true
    ...
    if msgType = "roSGNodeEvent"
        ' Handle request - add headers, certificates and escape urls
        request = msg.getData()
        ...
        ' Handle response received - parse JSON and create models
